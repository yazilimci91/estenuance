...
$(document).ready(function () {
	...
	$('#transitionType li a').click(function () {
		...
		$(owlElementID).trigger("http://demo.fuviz.com/reen/v1-4/assets/js/owl.next");
	...
	$(".slider-next").click(function () {
		owl.trigger('http://demo.fuviz.com/reen/v1-4/assets/js/owl.next');
	})
	
	$(".slider-prev").click(function () {
		owl.trigger('http://demo.fuviz.com/reen/v1-4/assets/js/owl.prev');
	})
