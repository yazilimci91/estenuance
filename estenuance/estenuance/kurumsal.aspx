...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<main>
			...
			<div class="container inner">
				<div class="row">
					...
					<div class="col-md-8 inner-right-md">
						...
						<!-- ============================================================= SECTION – HAKKIMIZDA BAŞ. ============================================================= -->
						
						<section id="vizyonumuz" class="inner-top-sm" name="hakkimizda">
							<div class="row">
					...
					<div class="col-md-4">
						...
						<section id="team" class="light-bg inner-xs inner-left-xs inner-right-xs">
							...
							<h3 class="team-headline sidelines text-center"><span>Ekibimiz</span></h3>
					...
					<div class="row">
						<div class="col-sm-10 center-block inner-top-sm">
							<div id="owl-office" class="owl-carousel owl-outer-nav owl-ui-md">
								...
								<div class="item">
									<figure>
										<img src="images/klinik1.jpeg" alt="">
									</figure>
								</div><!-- /.item -->
								
								<div class="item">
									<figure>
										<img src="images/klinik2.jpeg" alt="">
									</figure>
								</div><!-- /.item -->
								
								<div class="item">
									<figure>
										<img src="images/klinik3.jpeg" alt="">
									</figure>
								</div><!-- /.item -->
			...
			<!-- ============================================================= SECTION – İŞ BAŞVURUSU BAŞ. ============================================================= -->
			
			<section id="get-in-touch" class="tint-bg">
				<div class="container inner-sm">
					<div class="row">
						<div class="col-sm-10 center-block text-center">
							<h1 class="single-block">Bizimle çalışmak ister misiniz ? <a href="contact.html" class="btn btn-large">Başvuru</a></h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container -->
			</section>
			
			<!-- ============================================================= SECTION –İŞ BAŞVURUSU BİT. ============================================================= -->
