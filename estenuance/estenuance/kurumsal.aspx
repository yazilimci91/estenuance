...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<main>
			...
			<div class="container inner">
				<div class="row">
					...
					<div class="col-md-8 inner-right-md">
						...
						<section id="hero">
							<header>
								<h1>We're REEN – <br>a creative and digital Agency</h1>
							</header>
						</section>
						...
						<section id="who-we-are" class="inner-top-sm" name="hakkimizda">
							<div class="row">
								...
								<div class="col-sm-6 thumb">
									<figure class="member">
										...
										<div class="member-image">
											...
											<img src="images/human03.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/human03.jpg">
								...
								<div class="col-sm-6 thumb">
									<figure class="member">
										...
										<div class="member-image">
											...
											<img src="images/human01.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/human01.jpg">
								...
								<div class="col-sm-6 thumb">
									<figure class="member">
										...
										<div class="member-image">
											...
											<img src="images/human05.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/human05.jpg">
								...
								<div class="col-sm-6 thumb">
									<figure class="member">
										...
										<div class="member-image">
											...
											<img src="images/human04.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/human04.jpg">
								...
								<div class="col-sm-6 thumb last-bottom">
									<figure class="member">
										...
										<div class="member-image">
											...
											<img src="images/human06.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/human06.jpg">
								...
								<div class="col-sm-6 thumb last-bottom">
									<figure class="member">
										...
										<div class="member-image">
											...
											<img src="images/human02.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/human02.jpg">
			...
			<section id="values" class="tint-bg img-bg-bottom img-bg-softer" style="background-image: url(slider04.jpg)/*tpa=http://demo.fuviz.com/reen/v1-4/assets/images/art/slider04.jpg*/;">
					...
					<div class="row">
						<div class="col-sm-10 center-block inner-top-sm">
							<div id="owl-office" class="owl-carousel owl-outer-nav owl-ui-md">
								...
								<div class="item">
									<figure>
										<img src="office01.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/office01.jpg" alt="">
									</figure>
								</div><!-- /.item -->
								
								<div class="item">
									<figure>
										<img src="office02.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/office02.jpg" alt="">
									</figure>
								</div><!-- /.item -->
								
								<div class="item">
									<figure>
										<img src="office03.jpg" tppabs="http://demo.fuviz.com/reen/v1-4/assets/images/art/office03.jpg" alt="">
									</figure>
								</div><!-- /.item -->
				...
				<div class="container inner-top inner-bottom-sm">
					<div class="row">
						...
						<div class="col-md-3 inner-right-xs inner-bottom-xs">
							<h2>Why you should work with REEN</h2>
						</div><!-- /.col -->
						
						<div class="col-md-3 inner-right-xs inner-bottom-xs">
							<h3>Pixels friendly</h3>
							<p>Magnis modipsae que lib voloratati andigen daepeditem quiate re porem aut labor quiae sitiorem rest tumquam core.</p>
						</div><!-- /.col -->
				...
				<div class="container inner-sm">
					<div class="row">
						<div class="col-sm-10 center-block text-center">
							<h1 class="single-block">Want to work with us? <a href="contact.html" tppabs="http://demo.fuviz.com/reen/v1-4/contact.html" class="btn btn-large">Get in touch</a></h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container -->
			</section>
